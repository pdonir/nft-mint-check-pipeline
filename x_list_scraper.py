...
COOKIES_FILE = str(Path(__file__).parent.parent / "twitter_cookies.json")
HOURS_WINDOW = 13
...
async def main():
    list_urls_file = os.path.join(os.path.dirname(__file__), "list_nft.json")
    ...
    output_file = os.path.join(os.path.dirname(__file__), "scraped_links.json")
